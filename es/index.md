...
themes:
  - |
    ...
    *﻿*{: .fa-solid .fa-box-open} mantiene conjuntos de datos abiertos
    ([tales como este](https://dados.gov.br/dados/conjuntos-dados/sistema-de-transportes-de-servidores-publicos---taxigov-v2))
...
* 🌐 Online, 23/4/2024 --
  ...
  [Grupo de Trabajo de Implementación del Open Data Charter](https://opendatacharter.org/iwg/)
  ([grabación](https://www.youtube.com/watch?v=XrRUQI595KM))
...
* 🌐 Online, 26/5/2023 -- Integrating data sources and publishing open
  data with fastETL, Airflow & Frictionless Data (en inglés) --
  Frictionless Data Community Call
  ([presentación](https://herrmann.tech/slide-decks/2023/05/integrating-data-sources-and-publishing-open-data-with-fastetl-airflow-and-frictionless))
  ([grabación](https://www.youtube.com/watch?v=tDo-nNEDxVo))
* 🇦🇷 Buenos Aires, 19/4/2023 --
  [Integración de fuentes de datos y publicación de datos abiertos con FastELT y Airflow](https://csvconf.com/speakers/#augusto-herrmann) (en inglés)
  -- [csv,conf,v7](https://csvconf.com)
  ([presentación](/slide-decks/2023/04/integrating-data-sources-and-publishing-open-data-with-fastetl-and-airflow))
...
* 🇧🇷 Rio de Janeiro (Online), 2/12/2022 --
  [Organizando los datos abiertos](/slide-decks/2022/12/organizando-os-dados-abertos)
  (en portugués),
...
* 🇧🇷 Florianópolis, 29/8/2018 -- Plataformas de interoperabilidad y políticas
  de datos abiertos --
  [II Congreso Internacional de Rendimiento del Sector Publico](https://web.archive.org/web/20181221235945/http://cidesp.com.br/index.php/Icidesp/index/pages/view/2cidesp-programacao)
* 🇧🇷 Salvador, 19/7/2018 --
...
* 🇧🇷 Brasília, 25/6/2014 -- [Diálogo de políticas para datos gubernamentales abiertos](https://cg.df.gov.br/w/abertura-dos-dados-publicos-exige-participacao-dos-gestores-e-da-sociedade)
